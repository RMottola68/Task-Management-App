            ...
            <div className={'navbar bg-success border-bottom justify-content-center'}>
                <ul>
                    <li className={'d-inline-flex px-2 px-sm-5 align-middle'}>
                        <NavLink exact={true} activeClassName='is-active' activeStyle={{textDecoration: 'underline', textDecorationColor: 'white'}} to='/Tasks'>
                        <span className={'text-light font-weight-bold pointer'}>Tasks</span>
                        </NavLink>
                    </li>
                    <li className={'d-inline-flex px-2 px-sm-5 align-middle'}>
                        <NavLink activeClassName='is-active' activeStyle={{textDecoration: 'underline', textDecorationColor: 'white'}} to='/Completed'>
